      ...
      {[
        {
          ...
          icon: "../../public/assets/images/code.png", // You can use an icon related to frontend development, like a browser or code icon
          description:
...

        {
          ...
          icon: "../../public/assets/images/CSS3.png",
          description:
...

        {
          ...
          icon: "../../public/assets/images/nextjs.png",
          description:
        ...
        },
        {
          ...
          icon: "../../public/assets/images/Appwrite.png", // You can update with an icon related to API integration
          description:
